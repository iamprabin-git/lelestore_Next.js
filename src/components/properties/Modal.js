...
function DeletePropertyModal({ showModal=false, setShowModal, product, setProduct }) {
    function confirmDelete() {
      deleteProperty(product?.id).then(() =>toast.success("Product deleted successfully!", { autoClose: 750 }))
      .catch(
        (error) =>
          toast.error(
